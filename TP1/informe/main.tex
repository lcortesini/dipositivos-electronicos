...
Verificación LKI: $I_T = I_2 + I_3 ={837{,}6}\,\mu\text{A} $ (verificado)
...
\begin{enumerate}[leftmargin=*, label=\textbf{\arabic*.}]
    ...
    Las gráficas muestran que V(b) e I(R2) tienen comportamientos opuestos al variar R2: cuando R2 aumenta, la impedancia equivalente del paralelo R2|R3 crece, haciendo que una mayor proporción de la tensión de la fuente caiga en el nodo B y, por Ley de Ohm, la corriente por R2 disminuye. Esto demuestra que el nodo B es sensible a variaciones en R2: un componente fuera de tolerancia o degradado puede desplazar el punto de operación del circuito de forma significativa, lo que en un diseño real justifica el uso de resistores de baja tolerancia cuando la tensión en ese nodo sea crítica.
