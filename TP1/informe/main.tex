...
Mediciones Básicas \par}
    ...
    \begin{flushleft}
    \textbf{Integrantes:} \\
    Alejos Antony --- 412820 --- \\
    Cortesini Luciano --- 402719 ---\\
    Pedregoza Juan --- 408644 --- \\
...
\begin{figure}[H]
    ...
    \caption{Medici\'on de tensiones con multímetro sobre el circuito implementado.}
\end{figure}
...
\toprule
 & $V_S$ & $R_1$ & $R_2$ & $R_3$ \\
\midrule
Tensión   & 10V & 8,24V & 1,062V & 1,602V \\
 Corriente   & $831\,\mu\text{A}$ & $837\,\mu\text{A}$ & $327\,\mu\text{A}$ & $482\,\mu\text{A}$ \\
 Potencia    & $8{,}31\,\text{mW}$ & $6{,}89\,\text{mW}$ & $3{,}47\,\text{mW}$ & $5{,}12\,\text{mW}$ \\
\bottomrule
\end{tabular}
\end{table}
...
\multirow{3}{*}{Tensión}
    ...
    & Medición   & 10V & 8,24V & 1,062V & 1,602V \\
\midrule
...
\multirow{3}{*}{Potencia}
    ...
    & Medición   & $8{,}31\,\text{mW}$ & $6{,}89\,\text{mW}$ & $3{,}47\,\text{mW}$ & $5{,}12\,\text{mW}$ \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item {[Agregar referencias adicionales consultadas durante el TP.]}
\end{itemize}
